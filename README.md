...
1. **[GCP-DEPLOYMENT-GUIDE.md](GCP-DEPLOYMENT-GUIDE.md)** - Deploy Cloud Function to Google Cloud
2. **[SETUP-CONFIG-SHEET.md](SETUP-CONFIG-SHEET.md)** - Get Amazon credentials & configure Config sheet
3. **[SAFE-TESTING-GUIDE.md](SAFE-TESTING-GUIDE.md)** - Test safely without risking live products
4. **[DEPLOYMENT.md](DEPLOYMENT.md)** - Complete deployment walkthrough
5. **[CHANGELOG.md](CHANGELOG.md)** - All changes and improvements
...
### Setup Steps (5-Step Process)

#### Step 1: Deploy Cloud Function ☁️
See **[GCP-DEPLOYMENT-GUIDE.md](GCP-DEPLOYMENT-GUIDE.md)** for detailed instructions.

**Quick version**:
1. Go to Google Cloud Console → Cloud Functions
2. Create new function: `lukoSpApiHandler`
3. Copy code from `cloud-function/index.js` and `package.json`
4. Deploy (takes ~5 minutes)
5. Copy the Trigger URL

#### Step 2: Get Amazon SP-API Credentials 🔑
See **[SETUP-CONFIG-SHEET.md](SETUP-CONFIG-SHEET.md)** for detailed instructions.

**Quick version**:
1. Go to Amazon Seller Central → Develop Apps
2. Create new app client
3. Get: LWA Client ID, LWA Client Secret
4. Self-authorize to get: Refresh Token
5. Find your Seller ID

#### Step 3: Create Google Sheets & Apps Script 📊
1. Create new Google Sheet
2. Extensions → Apps Script
3. Add all 12 .gs files from `apps-script/` folder
4. Save and authorize

#### Step 4: Configure Config Sheet ⚙️
Fill in Config sheet with:
- **Cloud Function URL** (from Step 1)
- **LWA Client ID** (from Step 2)
- **LWA Client Secret** (from Step 2)
- **Refresh Token** (from Step 2)
- **Seller ID** (from Step 2)

See **[SETUP-CONFIG-SHEET.md](SETUP-CONFIG-SHEET.md)** for exact format.

#### Step 5: Test Safely ✅
See **[SAFE-TESTING-GUIDE.md](SAFE-TESTING-GUIDE.md)** for complete testing strategy.

**Quick version**:
1. Create TEST product on Amazon (not live product!)
2. Add to ProductsMain sheet
3. Check Export checkbox ☑️
4. Menu: Export to Amazon → Export Products
5. Verify on Amazon Seller Central
6. ✅ Success!
